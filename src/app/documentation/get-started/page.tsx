...
export default function GetStartedPage() {
  return (
    <>
      <MobileHeader title="Get Started" />
      <DesktopHeader title="Get Started" />
      <div className="flex flex-col min-h-screen p-4 md:p-6 max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          <p className="lead">
            This guide will walk you through the basic steps to start using the
            AI Workspace effectively. Follow these instructions to set up your
